  ...
  if (!club) {
    return (
      <p className="text-center text-muted-foreground">
        Verein nicht gefunden. <Link href="/fassjagd" className="text-koder-orange hover:underline">Zur Fassjagd</Link>
      </p>
    );
  }
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <Link href="/fassjagd" className="text-sm font-semibold text-koder-orange hover:underline">
          ← Ganze Fassjagd
        </Link>
      </div>
      ...
      <Link
        ...
        className="inline-flex rounded-2xl bg-koder-orange px-5 py-3 text-sm font-semibold uppercase tracking-widest text-white hover:bg-koder-orange/90"
      >
        Mit-Starter per Sammelanmeldung
      </Link>
    </div>
  );
}
