...
const SAMSTAG_PROGRAMM = [
  { zeit: EVENT.zeitplan.find((z) => z.titel.includes("Startnummern"))?.zeit ?? "13:00", text: "Startnummernausgabe am Eventtag", icon: Ticket },
  { zeit: EVENT.zeitplan.find((z) => z.streckeId === "spielerei")?.zeit ?? "16:00", text: "Koderlauf – Start der Strecken (Spielerei zuerst)", icon: Route },
  { zeit: EVENT.zeitplan.find((z) => z.titel.includes("Siegerehrung"))?.zeit ?? "19:30", text: "Siegerehrung am Sportheim", icon: Trophy },
