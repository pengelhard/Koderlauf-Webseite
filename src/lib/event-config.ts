...
export const EVENT = {
  ...
  name: "Koderlauf",
  alternateName: "Koderlauf Obermögersheim",
  ort: "Obermögersheim",
  ortDetail: "Sportheim Obermögersheim",
  veranstalter: "SV Obermögersheim 1977 e. V.",
  veranstalterAlias: "Sportverein Obermögersheim",
  adresse: {
    streetAddress: "Obermögersheim 1",
    postalCode: "91717",
    addressLocality: "Wassertrüdingen",
